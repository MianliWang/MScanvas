...
retention-time unit, one declaring no intensity unit, and one whose scans
declare differing retention-time units** — seven cases none of the inherited
four carries. **Plus
