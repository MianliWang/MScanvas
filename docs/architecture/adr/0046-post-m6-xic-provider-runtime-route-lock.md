...
overflows the accumulation domain, a scan declaring no retention time, and a
source declaring no m/z-array unit** — four cases none of the inherited four
carries — and **at most two** new
representative
