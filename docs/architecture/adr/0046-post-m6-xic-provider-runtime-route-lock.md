...
fixtures, M5.4's two generated fixtures, and **generated fixtures carrying twelve
...
a run mixing a declared unit with an undeclared one is refused, and has its own
fixture above.
