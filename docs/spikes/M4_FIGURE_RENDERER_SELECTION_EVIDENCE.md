...
| --- | ---: | ---: | ---: | ---: |
| chromatogram-100k | 100,000 | 1,614,214 | 12 | 5 |
| profile-dense-60k | 60,000 | 969,537 | 13 | 6 |
| centroid-dense-20k | 20,000 | 484,121 | 12 | 5 |
| transfer-bound-500k | 500,000 | 8,066,273 | 13 | 6 |
...
| --- | ---: | ---: | ---: |
| chromatogram-100k | 100,000 | 1,800 | 30,723 |
| profile-dense-60k | 60,000 | 1,800 | 30,932 |
| centroid-dense-20k | 20,000 | 1,800 | 45,065 |
| transfer-bound-500k | 500,000 | 1,800 | 30,910 |
...
it (8,066,273 vs 30,910 bytes). That ratio is the difference candidate A silently
elided.
...
The byte counts were byte-identical in all four runs (`1,614,214` and
`8,066,273` every time) while the timings moved by up to 4.6×. These are
...
```text
empty          svg_bytes=  1686  elements=11  finite_only=true chrome_free=true external_free=true
single-point   svg_bytes=  1708  elements=12  finite_only=true chrome_free=true external_free=true
flat           svg_bytes= 24797  elements=12  finite_only=true chrome_free=true external_free=true
all-negative   svg_bytes= 24911  elements=13  finite_only=true chrome_free=true external_free=true
all-zero       svg_bytes= 33956  elements=12  finite_only=true chrome_free=true external_free=true
```
