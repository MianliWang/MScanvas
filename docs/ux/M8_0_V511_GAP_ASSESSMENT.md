...
| Reusable QC summaries and report surfaces | Built by M8.5 as a descriptive QC summary snapshot copied from a retained preview, with a report in the Project surface; not the M9 QC recipe |
