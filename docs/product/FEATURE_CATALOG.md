...
**Since M6.4 the conversion semantics are chosen rather than fixed.** Four
...
Reachable that far and no further. CNV-001, CNV-004, CNV-005, CNV-006, CNV-007
and CNV-008's fail/skip half are reachable, each in the combinations the evidence
