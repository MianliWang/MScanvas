...
It ends with a hundred-and-sixty-obligation acceptance ledger: seventeen families
from PR
#95, and a hundred and forty-three more from findings raised against this record's own drafts. Every
...
**Those hundred and forty-three are worth recording, because they are the same shapes one layer
