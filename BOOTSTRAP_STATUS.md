...
It ends with a ninety-nine-obligation acceptance ledger: seventeen families
from PR #95, and eighty-two more from findings raised against this record's own
drafts.
...
**Those eighty-two are worth recording, because they are the same shapes one layer
