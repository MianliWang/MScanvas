...
It ends with a hundred-and-forty-three-obligation acceptance ledger: seventeen families
from PR
#95, and a hundred and twenty-six more from findings raised against this record's own drafts. Every
...
**Those hundred and twenty-six are worth recording, because they are the same shapes one layer
