...
It ends with a forty-three-obligation acceptance ledger: seventeen families
from PR #95, and twenty-six more from findings raised against this record's own
drafts.
...
**Those twenty-six are worth recording, because they are the same shapes one layer
