...
It ends with a fifty-eight-obligation acceptance ledger: seventeen families
from PR #95, and forty-one more from findings raised against this record's own
drafts.
...
**Those forty-one are worth recording, because they are the same shapes one layer
