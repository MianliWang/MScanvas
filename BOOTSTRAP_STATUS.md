...
It ends with a hundred-and-seventy-one-obligation acceptance ledger: seventeen families
from PR
#95, and a hundred and fifty-four more from findings raised against this record's own drafts. Every
...
**Those hundred and fifty-four are worth recording, because they are the same shapes one layer
