...
It ends with a hundred-and-eighty-obligation acceptance ledger: seventeen
families from PR
#95, and a hundred and sixty-three more from findings raised against this record's own drafts. Every
...
**Those hundred and sixty-three are worth recording, because they are the same shapes one layer
