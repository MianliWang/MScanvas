...
It ends with an eighty-nine-obligation acceptance ledger: seventeen families
from PR #95, and seventy-two more from findings raised against this record's own
drafts.
...
**Those seventy-two are worth recording, because they are the same shapes one layer
