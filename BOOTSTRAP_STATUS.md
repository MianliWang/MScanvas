...
It ends with a hundred-and-fourteen-obligation acceptance ledger: seventeen families
from PR
#95, and ninety-seven more from findings raised against this record's own drafts. Every
...
**Those ninety-seven are worth recording, because they are the same shapes one layer
