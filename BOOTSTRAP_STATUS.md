...
It ends with a hundred-and-thirty-three-obligation acceptance ledger: seventeen families
from PR
#95, and a hundred and sixteen more from findings raised against this record's own drafts. Every
...
**Those hundred and sixteen are worth recording, because they are the same shapes one layer
