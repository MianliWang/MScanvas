...
It ends with a hundred-and-twenty-eight-obligation acceptance ledger: seventeen families
from PR
#95, and a hundred and eleven more from findings raised against this record's own drafts. Every
...
**Those hundred and eleven are worth recording, because they are the same shapes one layer
