...
It ends with a hundred-and-thirty-four-obligation acceptance ledger: seventeen families
from PR
#95, and a hundred and seventeen more from findings raised against this record's own drafts. Every
...
**Those hundred and seventeen are worth recording, because they are the same shapes one layer
