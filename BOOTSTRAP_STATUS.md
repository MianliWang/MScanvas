...
It ends with a ninety-three-obligation acceptance ledger: seventeen families
from PR #95, and seventy-six more from findings raised against this record's own
drafts.
...
**Those seventy-six are worth recording, because they are the same shapes one layer
