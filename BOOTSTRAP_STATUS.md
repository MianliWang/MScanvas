...
It ends with a hundred-and-thirty-two-obligation acceptance ledger: seventeen families
from PR
#95, and a hundred and fifteen more from findings raised against this record's own drafts. Every
...
**Those hundred and fifteen are worth recording, because they are the same shapes one layer
