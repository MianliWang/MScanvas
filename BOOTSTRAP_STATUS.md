...
It ends with a ninety-eight-obligation acceptance ledger: seventeen families
from PR #95, and eighty-one more from findings raised against this record's own
drafts.
...
**Those eighty-one are worth recording, because they are the same shapes one layer
