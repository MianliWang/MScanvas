...
It ends with a hundred-and-thirty-nine-obligation acceptance ledger: seventeen families
from PR
#95, and a hundred and twenty-two more from findings raised against this record's own drafts. Every
...
**Those hundred and twenty-two are worth recording, because they are the same shapes one layer
