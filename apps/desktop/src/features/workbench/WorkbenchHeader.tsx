...
export function WorkbenchHeader({ surface, onNavigate, rosterOpen, onToggleRoster, detailsOpen, detailsAvailable, onToggleDetails, rowCount, busy, retained, dropStatus }: {
  ...
  readonly detailsOpen: boolean; readonly detailsAvailable: boolean; readonly onToggleDetails: () => void;
  ...
  return <header className="topbar workbench-header">
    ...
    <div className="workbench-global-actions">
      ...
      <button type="button" className="secondary-button" aria-expanded={detailsOpen} aria-controls="workbench-inspector" disabled={!detailsAvailable} title={detailsAvailable ? undefined : t("inspectorUnavailable")} onClick={onToggleDetails}>{t("inspectorToggle")}</button>
